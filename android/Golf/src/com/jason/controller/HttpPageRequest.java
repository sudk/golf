...
public class HttpPageRequest implements Runnable, Callback {
	...
	public HttpPageRequest(FragmentActivity context, JSONObject params, HttpCallback callBack) {
		_fgAct = context;
		_params = params;
		_callBack = callBack;
...
//					String des = "此处有错！！";
					...
					case 0:
						...
						header.put("comment_count", resObj.getString("comment_count"));
						header.put("service_total", resObj.getString("service_total"));
						header.put("design_total", resObj.getString("design_total"));
						header.put("facilitie_total", resObj.getString("facilitie_total"));
						header.put("lawn_total", resObj.getString("lawn_total"));
						
						JSONArray content = resObj.getJSONArray("data");
						
						JSONObject total = new JSONObject();
						total.put("header", header);
						total.put("content", content);
						
						if(_callBack != null) _callBack.sucessData(total.toString());
					...
					.setPositiveBtn(R.string.retry,
							new DialogInterface.OnClickListener() {
								...
								public void onClick(DialogInterface dialog,
										int which) {
									// TODO Auto-generated method stub
									GThreadExecutor.execute(HttpPageRequest.this);
								}
							})
