...
public class GTripImagesFragment extends Fragment {
...
public static final String KEY_IMG_URL = "Key_Img_Url";
	...
	public static GTripImagesFragment Instance() {
		// TODO Auto-generated method stub
		return new GTripImagesFragment();
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View v = inflater.inflate(R.layout.fragment_trip_imgs, null);
		mImages = (ViewPager) v.findViewById(R.id.trip_imgs);
