...
public class GOrderGenerateFragment extends Fragment implements OnClickListener {
	...
	public static GOrderGenerateFragment Instance() {
		return new GOrderGenerateFragment();
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		// TODO Auto-generated method stub
		View v = inflater.inflate(R.layout.fragment_order_generate, null);

		mAgentName = (TextView) v.findViewById(R.id.order_agent_name);
		mTeeTime = (TextView) v.findViewById(R.id.order_tee_time);
		mAmount = (TextView) v.findViewById(R.id.order_amount);
		mPrice = (TextView) v.findViewById(R.id.order_price);
		mPaytype = (TextView) v.findViewById(R.id.order_paytype);

		mPlayerName = (EditText) v.findViewById(R.id.order_players);
		mPhone = (EditText) v.findViewById(R.id.order_phone);
		...
		mPaytype.setText(GAgent.GetPayTypeDes(_payType));

		LinearLayout linearLayout1 = (LinearLayout) v
				.findViewById(R.id.order_pick_number);
	...
	public void onClick(View v) {
		...
		case R.id.order_submit:
			/*
			type	类型	String ordertype 订单类型，0、订场；1、行程；3、赛事报名；
			relation_id	关联ID	String
			relation_name	关联商品名称	String
			tee_time	打球时间	String
			count	数量	String
			unitprice	单价	String
			amount	订单金额	String
			pay_type	支付类型	String
			contact	联系人	String
			phone	电话	String
			agent_id	代理商ID	String
			*/
...
//					{"status":0,"desc":"\u6210\u529f","data":true}
					...
					try {
						...
						final String orderid = array.getJSONObject(0).getString("order_id");
						
						WarnDialog dialog = new WarnDialog(getActivity());
						dialog.setTitle(R.string.order).setMessage(R.string.order_successful)
						.setPositiveBtn(R.string.confirm, new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog, int which) {
								...
								params.putInt(GOrderActivity.FRAGMENT_MARK, GOrderActivity.FRAGMENT_MARK_VIEW_ORDER);
								params.putString(GOrderDetailsFragment.KEY_ORDER_ID, orderid);
