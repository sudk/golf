...
public class CourtImgsAdapter extends PagerAdapter {
	...
	public CourtImgsAdapter(Context ctx, ArrayList<String> advers) {
...
//		LayoutInflater inflater = (LayoutInflater) ctx.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
	...
	public void swapData(ArrayList<String> advers){
