...
public class GFleeImagesFragment extends Fragment {
	...
	public static GFleeImagesFragment Instance() {
		// TODO Auto-generated method stub
		return new GFleeImagesFragment();
	}
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mImgPos = getArguments().getInt(KEY_IMG_POS, 0);
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,	Bundle savedInstanceState) {
		...
		View v = inflater.inflate(R.layout.fragment_flee_imgs, null);
		mImages = (ViewPager) v.findViewById(R.id.flee_imgs);
