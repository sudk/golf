...
<table class="formList">
    ...
    <tr class="line">
        ...
        <td class="mivalue" colspan="3">
            <input type="checkbox" name="service[]" id="service1" value="1" <?php if($model->is_green != '0'){ echo "checked";}?>/><label for="service1">18洞果岭</label>
            <input type="checkbox" name="service[]" id="service2" value="2" <?php if($model->is_caddie != '0'){ echo "checked";}?>/><label for="service2">球童</label>
           <input type="checkbox" name="service[]" id="service3" value="3" <?php if($model->is_car != '0'){ echo "checked";}?>/> <label for="service3">球车</label>
            <input type="checkbox" name="service[]" id="service4" value="4" <?php if($model->is_wardrobe != '0'){ echo "checked";}?>/><label for="service4">更衣柜</label>   
            <input type="checkbox" name="service[]" id="service5" value="5" <?php if($model->is_meal != '0'){ echo "checked";}?>/><label for="service5">简餐</label>
            <input type="checkbox" name="service[]" id="service6" value="6" <?php if($model->is_insurance != '0'){ echo "checked";}?>/><label for="service6">保险</label>
            <input type="checkbox" name="service[]" id="service7" value="7" <?php if($model->is_tip != '0'){ echo "checked";}?>/><label for="service7">小费</label>
        </tr>
    <?php
    $week_day = array(
        '1'=>'周一',
