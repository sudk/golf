...
<table class="formList">
    ...
    <tr>
        ...
        <td class="mivalue">
           <?php
                echo $form->activeTextField($model, 'price', array('title' => '本项必填', 'class' => 'input_text', 'maxlength' => 10), 'required&number');         
            ?>
        </td>
        <td class="maxname">&nbsp;</td>
        <td class="mivalue">
    ...
    <tr>
        ...
        <td class="mivalue" colspan="3">
            <?php echo $form->activeTextArea($model, 'desc', array('title' => '本项必填','id'=>'desc','style'=>'height:100px;width:400px;float:left;'), 'required'); ?></td>
    </tr>
   
    <tr>
        <td class="maxname">物品图片：</td>
        <td class="mivalue"  colspan="3">
