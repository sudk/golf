<form name="_query_form" id="_query_form" action="javascript:itemQuery(0);">
    ...
    <li>
        ...
        <input name="q[user_id]" type="hidden" class="grayTips" value="<?php echo $_SESSION['cur_user_id'];?>"/>
...
<?php echo $this->oGridId; ?>.condition = url;
<?php echo $this->oGridId; ?>.refresh();
    }
